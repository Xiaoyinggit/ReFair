...
def main():
    ...
    parser.add_argument('--data_path',type=str, default='data/ml_1m_diff2week.pkl')
    parser.add_argument('--log_dir', help='logging dir', type=str, default='./log')
    parser.add_argument('--save_path', help='save dir', type=str, default='./out')
    ...
    # logging path
    log_f = open(args.log_dir+'/training.log', 'w')
    ...
    for epoch in range(num_epochs):
        ...
        cum_loss=0
        cum_loss_info= {'rating_mse':0, 'ns_mse': 0, 'ns_reg_neg_loss':0, 'ns_reg_1sum_loss':0}
