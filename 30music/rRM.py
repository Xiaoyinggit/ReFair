...
def main():
    ...
    parser.add_argument('--config_file', type=str, default='config/rrm_config')
    parser.add_argument('--item_feats_file', type=str, default='data/30music_2left_new.pkl')

    parser.add_argument('--policy_name', type=str, help = "name of policy", default='rrm')
    parser.add_argument('--rnn_model_path',type=str, default='30music_rnnmodels/30music_pretrained_rnn_ckpt')
